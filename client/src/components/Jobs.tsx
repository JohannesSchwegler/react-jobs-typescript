...
const Jobs: React.FC<Props> = function ({ jobs }) {
  React.useEffect(() => {
    const welcomeItem: NodeListOf<HTMLElement> = document.querySelectorAll(".welcome-item");
    let delay = 0;
    // console.log(welcomeItem);
    welcomeItem.forEach((item: HTMLElement) => {
